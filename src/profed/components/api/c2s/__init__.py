...
async def init(config: dict, deactivate: List[str]) -> None:
    ...
    for routers, init_fn in [(["v1_search", "v1_accounts", "v1_statuses", "v1_pleroma", "v1_timelines", "v2_search"],
                             ...
                             (["v1_search", "v1_accounts", "v1_timelines", "v2_search"],
                              _projection_initializer(None,
                                                      ...
                                                      "c2s_instance_key")),
                             (["v1_timelines", "v1_statuses", "v1_pleroma", "v1_accounts", "profed_timeline"],
