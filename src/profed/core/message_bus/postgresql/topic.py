...
class Topic:
    ...
    def subscribe(self, subscriber: str, last_seen: int = 0, include_sequence_id: bool = False) -> AsyncGenerator[Dict[str, str], None]:
        return subscribe(self._pool, self._config, self._name, subscriber, last_seen, include_sequence_id)
