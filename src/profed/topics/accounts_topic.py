...
def _ignore(msg):
    return f"Ignoring malformed accounts event: {msg}"
...
def validate_accounts_event(event_type: str, payload: Dict) -> Optional[Dict]:
...
def validate_accounts_snapshot_item(item) -> Optional[Dict]:
